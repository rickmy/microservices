...
exports.RolDto = exports.RegisterDto = void 0;
const swagger_1 = require("@nestjs/swagger");
const class_validator_1 = require("class-validator");
class RegisterDto {
}
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'username', description: 'Username', required: true }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'name', description: 'name', required: true }),
    (0, class_validator_1.IsString)({ message: 'Name must be a string' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'Name must not be empty' }),
    __metadata("design:type", String)
], RegisterDto.prototype, "name", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'password', description: 'password', required: true }),
...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)({ message: 'Roles must not be empty' }),
